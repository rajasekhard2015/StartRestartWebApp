...
namespace StartRestartWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureWritable<AzureAdOptions>(Configuration.GetSection("AzureAd"));

            services.ConfigureWritable<SMTPSettingOptions>(Configuration.GetSection("Settings"));
